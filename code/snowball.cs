...
internal partial class Snowball : ModelEntity
{
	...
	public Vector3 snowballSpawnerPos = new Vector3(608,736,288);
	...
	public override void Spawn()
	{
		...
		Snowballe = new ModelEntity("models/things_from_kabubu2/snowball.vmdl");
		Snowballe.SetupPhysicsFromModel(PhysicsMotionType.Dynamic, false);
		...
		Snowballe.Position = new Vector3(rng.Next(-10, 11), rng.Next(-10, 11), 0) + snowballSpawnerPos;
		Snowballe.Rotation = Rotation.LookAt(Vector3.Random.Normal);
